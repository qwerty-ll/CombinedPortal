...
KNOWLEDGE_CHUNKS = [
    ...
    },
    {
        ...
        "content": (
            ...
            "• **Барило Илья Иванович** — Доцент кафедры ИСиТ, к.т.н., доцент (Базы данных, Веб-технологии).\n"
            "• **Лустгартен Юрий Леонидович** — Доцент кафедры ИСиТ, к.т.н., доцент (Моделирование, Исследование операций).\n"
            "• **Красавина Мария Сергеевна** — Доцент кафедры ИСиТ, к.т.н., доцент (Программирование, Алгоритмы).\n"
            "• **Прядкина Нина Олеговна** — Доцент кафедры ИСиТ, к.т.н., доцент (Операционные системы, Информационная безопасность).\n"
            "• **Смирнова Светлана Геннадьевна** — Доцент кафедры ИСиТ, к.т.н., доцент (Объектно-ориентированное программирование).\n"
            ...
            "• **Орлов Александр Валерьевич** — Доцент кафедры ИСиТ, к.т.н., доцент (Сети и телекоммуникации).\n"
            "• **Мозохин Александр Евгеньевич** — Доцент кафедры ИСиТ, к.т.н., доцент (Параллельное программирование).\n"
            ...
            "• **Иваницкий Виталий Викторович** — Доцент кафедры ИСиТ, к.т.н., доцент (Информационные системы).\n"
            "• **Попова Светлана Валентиновна** — Старший преподаватель кафедры экономики и управления (Экономика ИТ).\n"
            "• **Денисов Артем Руфимович** — Доцент кафедры ИиВТ, д.т.н., доцент (Искусственный интеллект, Нейронные сети).\n"
            "• **Дружинина Анна Григорьевна** — Доцент кафедры ИСиТ, к.т.н., доцент (Проектирование ИС, Базы данных).\n"
            "• **Кириллова Екатерина Сергеевна** — Доцент кафедры ИСиТ, к.т.н., доцент (Математическая логика, Дискретная математика).\n"
            "• **Чувиляева Александра Сергеевна** — Доцент кафедры ИСиТ, к.т.н., доцент (Мобильные приложения)."
        )
    }
]
