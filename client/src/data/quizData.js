export const QUIZ_QUESTIONS = [
  ...
  {
    id: 10,
    question: "Что такое СДО / ЭИОС КГУ?",
    options: [
      "Электронная среда и онлайн-платформа (eios.kosgos.ru / sdo.kosgos.ru), где доступны лекции, расписание, задания и тесты",
      "Сайт только для просмотра расписания",
      "Кабинет дирекции института",
      "Студенческое объединение института"
    ],
    correctIndex: 0,
    explanation: "СДО / ЭИОС КГУ — это единый цифровой портал университета (eios.kosgos.ru), где преподаватели выкладывают учебные материалы, тесты и задания, а также доступны расписание и портфолио студента."
  }
];
